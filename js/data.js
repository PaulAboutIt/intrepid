var services = [
  ...
  {title: "Meaningful Use of Electronic Health Records (ehrs)",
    text: "<strong>What we do:</strong> Support providers in meeting Meaningful Use requirements, especially new requirements in 2014 related to data exchange including Transitions of Care and:"},
  ...
  text: "<strong>What we do:</strong> Evaluate and improve the use of health IT applications within a practice or healthcare organization; workflow redesign for an integrated user experience to maximize provider satisfaction and effectiveness."}
];
